<template>
  <div class="relative inline-flex">
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full -mr-48 min-w-[20rem] sm:mr-0 min-w-80 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1" :class="align === 'right' ? 'right-0' : 'left-0'">
        ...
        >
          <li class="border-b border-slate-200 last:border-0">
            <Link class="block py-2 px-4 hover:bg-slate-50" to="#0" @click="dropdownOpen = false">
