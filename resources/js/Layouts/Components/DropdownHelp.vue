<template>
  <div class="relative inline-flex">
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-10 min-w-[11rem] absolute top-full min-w-44 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"  :class="align === 'right' ? 'right-0' : 'left-0'">
        ...
        >
          <li>
            <Link class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" to="#0" @click="dropdownOpen = false">
